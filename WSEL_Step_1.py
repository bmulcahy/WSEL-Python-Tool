...
class WSEL_Step_1:
    ...
    def add_zero_station(self, stream, xs_pt, min_station, name):
        ...
        arcpy.AddField_management(stream_startend,'Station',"FLOAT")        
        arcpy.CalculateField_management(stream_startend, 'Station', 0, "VB")
        stream_start =[r for r in arcpy.da.SearchCursor (stream_startend,("Station","Shape@XY","Shape@Z","Shape@M"))]      
        
        cursor = arcpy.da.InsertCursor(xs_pt, ("Station","Shape@XY","Shape@Z","Shape@M"))
